...
var handleDateRangePicker = function() {
	...
	$('#advance-daterange span').html(moment().subtract('days', 29).format('YYYY.MM.D') + ' - ' + moment().format('YYYY.MM.D'));
	...
	$('#advance-daterange').daterangepicker({
		...
		$('#advance-daterange span').html(start.format('YYYY.MM.D') + ' - ' + end.format('YYYY.MM.D'));
	});
};
